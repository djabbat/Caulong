...
Caulong App— мобильное приложение для здоровья через дыхание, сон и питание

## О проекте

**Caulong v.0.0.1** — это инновационное приложение, помогающее пользователям улучшать здоровье посредством анализа состояния организма и персонализированных рекомендаций по дыханию, сну и питанию.
...
## Build
---
- Автоматическое создание БД и таблиц при старте
---
