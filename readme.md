...
- **Google Cloud Spanner** — база данных для миллиардов пользователей
...
FastAPI запущен на http://localhost:8000 -  как убедится

Я могу сделать экран добавления пациента
Или расширить список пациентов формой редактирования
Или реализовать связь между пациентами и профилем пользователя
>>>>>>> 6662d6e (1)